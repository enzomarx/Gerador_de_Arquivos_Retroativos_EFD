...
df = None
use_year_option = tk.BooleanVar(value=False)  
year_option = tk.StringVar() 

style = ttk.Style()
style.theme_use('clam')  # Usei 'clam' como tema base para que as modificações de cor sejam aplicadas corretamente
